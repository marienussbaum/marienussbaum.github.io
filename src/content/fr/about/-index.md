  ...
  items:
    - title: Consultations adultes – psychothérapie individuelle
      ...
      description: >-
        ...
        éprouvants (traumatisme, séparation, deuil, maladie, burnout,
        expatriation), ou à des schémas qui semblent se répéter dans les
        relations, le travail ou la vie familiale.
    ...
    - title: Accompagnement des adolescents
      ...
      description: >-
        ...
        émotions intenses (colère, anxiété, tristesse), des difficultés
        scolaires, un repli sur soi, des passages à l'acte, des conflits
        relationnels ou des questions identitaires.


        Les consultations offrent un espace où le jeune peut s'exprimer
    ...
    - title: Enfants et suivi familial
      ...
      description: >-
        ...
        des changements de comportement (agitation, opposition, repli), des
        difficultés émotionnelles, des problèmes scolaires, ou qui ont vécu des
        événements significatifs (séparation, deuil, maladie, déménagement,
        conflit familial…).


        Les rencontres avec les parents font partie intégrante du processus.
